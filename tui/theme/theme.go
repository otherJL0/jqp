...
var themeMap = map[string]Theme{
	...
	"catppuccin-frappe": {
		...
		ChromaStyle: styles.CatppuccinFrappe,
	},
	"catppuccin-latte": {
		...
		ChromaStyle: styles.CatppuccinLatte,
	},
	"catppuccin-macchiato": {
		Primary:     lipgloss.Color("#8aadf4"),
		Secondary:   lipgloss.Color("#f5bde6"),
		Inactive:    GREY,
		Success:     lipgloss.Color("#a6da95"),
		Error:       lipgloss.Color("#ed8796"),
		ChromaStyle: styles.CatppuccinMacchiato,
	},
	"catppuccin-mocha": {
		...
		ChromaStyle: styles.CatppuccinMocha,
	},
	"colorful": {
